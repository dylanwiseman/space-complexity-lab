...
// ANSWER: yes
function getNumbersSquared(numbers) {
  numbers = numbers.map(item => Math.pow(item, 2))
  return numbers;
}
...
// ANSWER: They both take input of string and return objects
